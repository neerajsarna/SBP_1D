...
M_values = sort([5,15,25,35,45,6,16,26,36,46]);

num_samples = length(M_values) + 1;
...
for i = M_values
    output_filename = strcat('wall_tend_',num2str(t_end),'_points_',num2str(n),'_neqn_');
    ...
    output_filename = strcat('wall_tend_',num2str(t_end),'_points_',num2str(n),'_neqn_');
    output_filename = strcat(output_filename,num2str(100),'.txt');
...
[norm_Odd_f_100,norm_Even_f_100] = norm_OddEven(result{num_samples},100,P);
[norm_Odd_f_dx_100,norm_Even_f_dx_100] = norm_dx_OddEven(result{num_samples},100,P,D);
...
figure(2)
loglog(odd_var(100),norm_Odd_f_100,'-o',even_var(100),norm_Even_f_100,'-o','MarkerSize',3);
xlabel('m','FontSize',10);
...
% 
figure(4)
loglog(odd_var(100),norm_Odd_f_dx_100,'-o',even_var(100),norm_Even_f_dx_100,'-o','MarkerSize',3);
xlabel('m','FontSize',10);
